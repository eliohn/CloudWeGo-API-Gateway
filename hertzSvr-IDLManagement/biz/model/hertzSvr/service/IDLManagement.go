...
type IDLQueryReq struct {
	Name string `thrift:"name,1" json:"name" query:"name"`
}

func NewIDLQueryReq() *IDLQueryReq {
	return &IDLQueryReq{}
}

func (p *IDLQueryReq) GetName() (v string) {
	return p.Name
}

var fieldIDToName_IDLQueryReq = map[int16]string{
	1: "name",
}

func (p *IDLQueryReq) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_IDLQueryReq[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *IDLQueryReq) ReadField1(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return err
	} else {
		p.Name = v
...
func (p *IDLQueryReq) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("IDLQueryReq"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *IDLQueryReq) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("name", thrift.STRING, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.Name); err != nil {
...
func (p *IDLQueryReq) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("IDLQueryReq(%+v)", *p)
}
...
type IDLService interface {
	...
	QueryIDL(ctx context.Context, idl *IDLQueryReq) (r *IDLInfo, err error)
}
...
func (p *IDLServiceClient) QueryIDL(ctx context.Context, idl *IDLQueryReq) (r *IDLInfo, err error) {
...
var IDLServiceQueryIDLArgs_Idl_DEFAULT *IDLQueryReq

func (p *IDLServiceQueryIDLArgs) GetIdl() (v *IDLQueryReq) {
	if !p.IsSetIdl() {
