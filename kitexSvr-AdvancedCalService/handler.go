...
import (
	"context"
	service "kitexSvr-FunctionCalService/kitex_gen/kitex/service"
...
// Fact implements the FunctionCalServiceImpl interface.
func (s *FunctionCalServiceImpl) Fact(ctx context.Context, request *service.Request) (resp *service.Response, err error) {
	// TODO: Your code here...
	return
}

// Fib implements the FunctionCalServiceImpl interface.
func (s *FunctionCalServiceImpl) Fib(ctx context.Context, request *service.Request) (resp *service.Response, err error) {
	// TODO: Your code here...
	return
}
