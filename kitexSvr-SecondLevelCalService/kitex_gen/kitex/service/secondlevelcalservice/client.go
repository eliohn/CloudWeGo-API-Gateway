...
func NewClient(destService string, opts ...client.Option) (Client, error) {
	...
	return &kSecondLevelCalServiceClient{
...
type kSecondLevelCalServiceClient struct {
	*kClient
}

func (p *kSecondLevelCalServiceClient) Mul(ctx context.Context, request *service.Request, callOptions ...callopt.Option) (r *service.Response, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.Mul(ctx, request)
}

func (p *kSecondLevelCalServiceClient) Div(ctx context.Context, request *service.Request, callOptions ...callopt.Option) (r *service.Response, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
